...
public class MaxTemperatureOfLocation {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String outputFinal = "max-temp-red-alert-weather-station";
        ...
        KStream<String, CombinedWeather> joinedStream = inputStream2.join(filteredStream1, valueJoiner,
                ...
                KGroupedStream<String, CombinedWeather> minTable = joinedStream.groupBy((k, v) -> v.getLocation(),
