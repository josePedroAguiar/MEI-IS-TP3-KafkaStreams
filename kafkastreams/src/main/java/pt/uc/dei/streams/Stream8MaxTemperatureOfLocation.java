...
public class Stream8MaxTemperatureOfLocation {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        props1.put(StreamsConfig.APPLICATION_ID_CONFIG, "exercises-application-fff");
        ...
        props2.put(StreamsConfig.APPLICATION_ID_CONFIG, "exercises-application-ffff");
        ...
        KStream<String, WeatherAlert> filteredStream1 = inputStream1
                ...
                .peek((key, value) -> System.out.println("Stream-Stream Join record key " + key + " value "
                        + value.getLocation() + " " + value.getType())).groupBy((k,v)->v.getLocation()).reduce((previousValue, newValue) -> newValue).toStream();
        ...
        KStream<String, CombinedWeather> joinedStream = inputStream2.join(filteredStream1, valueJoiner,
                ...
                //joinedStream.groupBy((k, v) -> v.getType()).count();
                                                                                                ...
                                                                                                //        |
                                                                                                //        v
                KGroupedStream<String, CombinedWeather> minTable = joinedStream.filter((k,v)->v.getType()!=null).groupBy((k, v) -> v.getLocation(),
