...
public class MinTemperatureOfWS {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        KStream<String, WeatherAlert> filteredStream1 = inputStream1
                ...
                .peek((key,value) ->  System.out.println("Stream-Stream Join record key " + key + " value " + value.getLocation() + " " + value.getType()))
        ;
        ...
        ValueJoiner<StandardWeather, WeatherAlert, StandardWeather> valueJoiner = (leftValue, rightValue) -> {
             System.out.println(leftValue.getLocation() + " " + rightValue.getType());
             return leftValue;
        };

        Serde weatherAlertSerde = new WeatherAlertSerde();
        Serde standardWeather = new StandardWeatherSerde();

        KStream<String, StandardWeather> joinedStream = inputStream2.join(filteredStream1, valueJoiner, JoinWindows.of(Duration.ofSeconds(10)), StreamJoined.with(Serdes.String(), standardWeather, weatherAlertSerde));
        


        KStream<String, String> finalStream =  joinedStream.mapValues(v -> v.getTemperature() +" " +v.getLocation());
